...
<action>Execute no terminal (run_shell_command) para sinalizar o dashboard:</action>
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Bob&status=working&message=Bob+criando+story+com+contexto+completo...'`
