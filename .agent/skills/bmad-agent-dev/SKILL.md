...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Amelia&status=working&message=Amelia+online.+TDD+em+primeiro+lugar,+codigo+limpo+e+testado.+Carregando+configuracoes...'`
...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Amelia&status=waiting&message=Pronto!+Aguardando+seu+comando.'`
...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Amelia&status=done&message=Amelia+encerrando+sessao.+Ate+a+proxima!'`
