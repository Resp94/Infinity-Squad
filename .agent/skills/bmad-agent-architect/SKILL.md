...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Winston&status=working&message=Winston+online.+Sistemas+pensados+para+durar.+Carregando+configuracoes...'`
...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Winston&status=waiting&message=Pronto!+Aguardando+seu+comando.'`
...
`curl.exe -s 'http://127.0.0.1:3105/active?agent=Winston&status=done&message=Winston+encerrando+sessao.+Ate+a+proxima!'`
