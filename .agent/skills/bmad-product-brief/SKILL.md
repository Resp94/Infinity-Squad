...
1. Execute no terminal (run_shell_command) para sinalizar o dashboard:
   `curl.exe -s 'http://127.0.0.1:3105/active?agent=Mary&status=working&message=Mary+criando+product+brief...'`
